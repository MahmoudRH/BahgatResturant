...
@Composable
fun MoreScreen(onMoreItemClick: (content: String?) -> Unit) {

    Column {
        AppTopBar(title = stringResource(R.string.more), backIcon = false)
                ...
                Box(
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .fillMaxWidth()
                            .clickable { onMoreItemClick(item::class.qualifiedName) }
